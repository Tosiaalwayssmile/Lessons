...
enum class CollisionState
{
    ...
    /**
     * Creature is colliding with something that is below, above, left, right from Creature.
     */
    FromAbove = 0x1,
    FromBelow = 0x2,
    FromLeft = 0x4,
...
public:
     ...
     * @see health
     */
    Creature(double x = 0.0, double y = 0.0, double width = 1.0, double height = 1.0, Uint8 heartRate = 1);
    ...
    /**
     * Changes heartRate of Creature.
     * If damage equals 127 then it ignores invulnerability.
