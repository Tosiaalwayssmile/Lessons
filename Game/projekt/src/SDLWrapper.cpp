...
void SDLWrapper::loadLevelTextures()
{
    ...
    //Loading PlayerLeft
    levelTextureVector.push_back(loadTextureFromFile("Data/images/mario_l.png"));
    if (levelTextureVector.back() == nullptr)
    {
        throw InitError();
    }
    //Loading PlayerRight
    levelTextureVector.push_back(loadTextureFromFile("Data/images/Mario_Switch.png"));
    if (levelTextureVector.back() == nullptr)
    {
        throw InitError();
    }
    //Loading PlayerFront
    levelTextureVector.push_back(loadTextureFromFile("Data/images/mario_front.png"));
    if (levelTextureVector.back() == nullptr)
    {
        throw InitError();
    }
    //Loading MonsterLeft
    levelTextureVector.push_back(loadTextureFromFile("Data/images/monster.png"));
    if (levelTextureVector.back() == nullptr)
    {
        throw InitError();
    }
