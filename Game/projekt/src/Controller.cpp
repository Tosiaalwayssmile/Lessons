...
void Controller::control()
{
    ...
    {
    case ControllerState::GoingBackward:
        goBackward();
        break;
    case ControllerState::GoingForward:
        goForward();
        break;
...
{
    controllerState = ControllerState::GoingForward;
    creature->setSpeedVector(creature->getSpeedX(), -1.0*maxSpeed);
}
...
{
    controllerState = ControllerState::GoingBackward;
    creature->setSpeedVector(creature->getSpeedX(), 1.0*maxSpeed);
}
...
void Controller::stopGoing()
{
    ...
    creature->setSpeedVector(0.0, 0.0);
}
