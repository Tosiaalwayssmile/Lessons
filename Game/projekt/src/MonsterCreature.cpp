 ...
 * @param heartRate heartRate of MonsterCreature. Defaults to 1
 * @see Creature
 */
MonsterCreature::MonsterCreature(double x, double y, double width, double height, Uint8 heartRate) :
